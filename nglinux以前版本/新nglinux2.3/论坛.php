...
<body style="background: #f8f8f8;margin:0px;overflow-x: hidden;">
	...
	<form id="myForm" action="./论坛/POST.php" method="post">
		<textarea style="margin-left:100px; font-size: 20px;background: transparent;" name="textarea" id="textarea" placeholder="欢迎留言,提交留言后刷新即可在下方看到你的足迹。&#13;&#10;点击左上角logo可返回主页." cols="60" rows="8"></textarea>
	...
	<span style="font-size: 1.3em;color:red;padding: 33px;">轻风:&nbsp&nbsp欢迎各位到来，一个月后开放账号注册登录，两个月后完善论坛功能，在这里你是否无所不言？</span>
	<div style="border-bottom: 1px dashed #999;"></div>
	<?php 
	$fh=fopen('./论坛/forum.txt','r');
	while(($row=fgetcsv($fh))!=false){?>
	<span style="font-size: 1.3em;padding: 33px;">游客:&nbsp&nbsp<?php print_r($row[0]); ?></span>
	<?php echo '<br/>'; ?>
	<div style="border-bottom: 1px dashed #999;"></div>
    <?php } ?>
</body>
