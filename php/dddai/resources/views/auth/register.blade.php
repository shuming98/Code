...
<html>
 ...
 <body class="nwd_index">
  <div class="mboxDefault" id="mbox-target-global-mbox-1458134936554-258397" style="visibility: visible; display: block;"></div>
  <div class="mboxDefault" id="mbox-target-global-mbox-1458040677304-320799" style="visibility: visible; display: block;"></div> 
  <!--header start--> 
  <!--main--> 
  <!--静态化 - 头部内容----> 
  <!--main--> 
  <div class="clearfix simpleHead01"> 
   <div class="fl"> 
    <a href="{{url('/')}}"><img height="52" style="vertical-align: initial;" alt="点点贷" src="/image/logo_all.png" /></a>
    <span>注册</span> 
   </div> 
   <div class="fr">
    <span class="fc_6">已有帐号？<a class="blue" href="{{url('login')}}">立即登录</a></span>
   </div> 
  </div> 
    ...
    <div class="clearfix nwd_loginOut"> 
     ...
     <form action="" method="post">
      ...
      <div class="content_box pb_20"> 
       <label class="input_text yzm3"> <input type="text" class="inp_bor inpIco3" placeholder="手机号" id="u" name="mobile" /> </label> 
       <label class="input_text yzm3"> <input type="text" class="inp_bor inpIco3" placeholder="用户名" id="uname" name="name" /> </label> 
       <label class="input_text yzm3"> <input type="text" class="inp_bor inpIco3" placeholder="Email" id="email" name="email" /> </label> 
       <label class="input_text yzm3"> <input type="text" class="inp_bor inpIco3" placeholder="密码" id="pwd" name="password" /> </label> 
       <label class="input_text yzm3"> <input type="text" class="inp_bor inpIco3" placeholder="确认密码" id="repwd" name="password_confirmation" /> </label> 
       <!--div class="input_prompt"> <span class="fs_14 fc_6" id="mobileMsg" style="display: block;"><i class="ico ico_s14 ico3"></i>手机号码不能为空</span>
                        </div--> 
       <label class="input_text yzm3"><i class="fr yzm_img"><img width="80" height="32" src="/image/refresh.jpg" id="imgc" /></i> <input type="text" class="inp_bor inpIco5" placeholder="验证码" id="imgcode" name="imgcode" /> </label> 
       <input type="submit" value="免费注册" class="btn_resize btn_orange w_10  mb_10" id="submitBtn" /> 
       <div class="fc_9">
        注册即视为同意
        <a href="javascript:void(0);" class="fc_blue">《点点贷用户协议》</a>
       </div> 
      </div> 
     </form> 
    </div> 
  ...
  <div class="newmainbg"> 
   <div class="title reg_step1"> 
    <h3>第1重大礼</h3> 
    <p>注册即送1万元体验金+100元红包 
     <!--<span>体验金与红包已发至您的个人账户</span>--> </p> 
   </div> 
   <div class="title reg_step2"> 
    <h3>第2重大礼</h3> 
    <p>我出本金，你赚收益，体验投资乐趣 <span>投资体验宝，立享3天8.8%预期年化收益</span> </p> 
   </div> 
   <div class="reg_step2_1"> 
    ...
    <div class="tybleft fl"> 
     <em class="fc_orange airal">8.8%</em>
     <span>预期年化</span> 
    </div> 
    <div class="tybright fr"> 
     <em class="fc_6 airal">3天</em>
     <span>期限</span> 
    </div> 
    <div class="addtyb">
   ...
   <div class="title reg_step3"> 
    <h3>第3重大礼</h3> 
    <p> 一份本金，双份收益，投多少送多少 <span>注册7天内，完成首次投资送等额体验金</span> </p> 
   </div> 
         ...
         <div style="opacity: 1;" type="1" class="item middle"> 
          ...
          <div class="main-content"> 
           ...
           <div class="details-box"> 
            ...
            <a class="addmoney"  href="javascript:void(0);">立即抢购</a> 
           </div> 
          </div> 
          <div class="wave"></div> 
         </div> 
  ...
  <div style="border-top: 1px solid #e4e7ec;"> 
   <div class="login_foot w1000 txcenter"> 
    ...
    <div class="line3 mt_10"> 
     <a href="javascript:void(0);"  class="img1" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
     <a href="javascript:void(0);"  class="img2" rel="nofollow"><img width="70" height="32" src="/image/px_002.gif" /></a> 
     <a href="javascript:void(0);"  class="img3" rel="nofollow"><img width="70" height="32" src="/image/px_002.gif" /></a> 
     <a href="javascript:void(0);"  class="img4" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
     <a href="javascript:void(0);"  class="img5" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
     <a href="javascript:void(0);"  class="img6" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
     <a href="javascript:void(0);"  class="img7" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
     <a href="javascript:void(0);"  class="img8" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
     <a href="javascript:void(0);"  class="img9" rel="nofollow"><img width="70" height="32" src="/image/px.gif" /></a> 
    </div> 
   </div> 
  </div> 
  <!--main  end--> 
