	...
	<div class="manage_container">
		...
		<div class="function">
			...
			<form action="" method="get">
				<input type="text" name="account" maxlength="20" placeholder="请输入教师账号" required="required">
			...
			<div id="modify_tagname" class="modal">
				<div class="modify_tagname_content animate">
					<h1><img src="../../images/icon/work.png" alt="img">修改标签名</h1>
...
$(".res_modify").click(function(event){
	...
	$("#modify_tagname_form").submit(function(){
