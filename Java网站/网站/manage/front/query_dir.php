...
if(isset($_GET['account'])){
	$sql = "select dirname_id,study_dir.dirname,art_num from study_dir left join (select dirname,count(*) as art_num from article group by dirname) as t on study_dir.dirname=t.dirname where user_account='$_GET[account]' order by dirname_id asc";
	$dir = mGetAll($sql);
	...
	<div class="manage_container">
		...
		<div class="function">
			...
			<div id="modify_dirname" class="modal">
				<div class="modify_dirname_content animate">
					<h1><img src="../../images/icon/work.png" alt="img">修改目录名</h1>
...
$(".res_modify").click(function(event){
	...
	$("#modify_dirname_form").submit(function(){
