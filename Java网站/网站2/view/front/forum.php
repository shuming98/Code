...
<body style="background:#fff;">
	...
	<?php 
	 ...
	 ?>
		<a href="./add_post.php"><img style="width:20px;margin-right:5px" src="../../images/icon/user.png" alt="">我要发帖</a>
	</div>
	...
	<div class="forum_top_notice">
		...
		<?php foreach($notice as $v){ 
			echo '<span class=
			"li_dot" style="margin-right:-10px;position:relative;top:5px ;left:30px;color:#748FC9">&#8226;</span><p><a href="./forum_show?post_id=',$v['post_id'],'">','[',$v['cat_name'],']',$v['post_title'],'</a><span>',$v['user_nick'],' ',timeDiff($v['pubtime']),'</span></p>';
		} ?>
		</div>
	</div>
	<!--讨论帖子区-->
		...
		$pageview = mGetOne($sql10);
			...
			<div class="forum_one_message">
				<div class="forum_message_left">
					<p><a href="./forum_show?post_id=<?php echo $v['post_id']; ?>"><?php echo '<span style="color:#748fc9;margin-right:5px">[',$v['cat_name'],']</span>',$v['post_title'];	 ?></a></p>
					<?php echo '<p>',$v['post_nick'],' <span>',timeDiff($v['post_time']),'</span>','<span class="post_message"><span class="post_message_pageview"><img src="../../images/icon/view.png" alt="like">',$pageview,'</span><span class="post_message_replysum"><img src="../../images/icon/view.png" alt="like">',$v['reply_sum'],'</span><span class="post_message_like"><img src="../../images/icon/like.png" alt="like">',$v['likes'],'</span></span></p>';?>
				</div>
