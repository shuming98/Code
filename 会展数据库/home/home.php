...
#am{width: 100%;height: 666px;background: #472b68;}
#title{
  color: #FFF;
  font-weight: 100;
  font-size: 3em;
  padding: 0;
  margin: auto;
  text-shadow: 0 0 10px #00a2ca,0 0 20px #00a2ca,0 0 30px #00a2ca,0 0 40px #00b4ca,0 0 70px #00b4ca,0 0 80px #00b4ca,0 0 100px #00b4ca,0 0 150px #00b4ca;
  position: relative;
  left: 28%;
  top: 40%;
}
  ...
  <div class="container">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="../account/account_update.php">账号信息更新</a>
      </div>
    </div> 
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="../user/user_update.php">用户信息更新</a>
      </div>
    </div> 
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="../exhibitor/exhibitor_update.php">展商信息更新</a>
      </div>
  </div> 
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="../message/message_update.php">留言信息更新</a>
    </div>
  </div> 
